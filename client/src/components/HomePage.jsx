...
function HomePage() {
  ...
  return (
    <div className="relative flex flex-col lg:flex-row items-start min-h-screen bg-cover bg-fixed bg-center" style={{ backgroundImage: "url('https://www.build-review.com/wp-content/uploads/2020/07/luxury-real-estate.jpg')" }}>
